           ...
           PROCEDURE DIVISION USING   MovieRand, SuggDecade,
                                        SuggestionTable.
      *    DISPLAY "Movie Rand: " MovieRand                                        
      *    DISPLAY "Sugg Decade" SuggDecade
           MOVE SuggDecade(1:1) TO HoldDecade
      ...
      *    DISPLAY "-------------LOOP-------------- " IDX
           ...
           COMPUTE MovieRand = FUNCTION RANDOM * (MovieMod - 
                               MinNum + 1) + MinNum
           add 1 to seed
           INSPECT FUNCTION REVERSE(RandomMovie(MovieRand)) TALLYING
                                       CharCount FOR LEADING SPACES         
      *    DISPLAY "Movie Decade Test: " 
      *      RandomMovie(MovieRand)(59 - Charcount : 2) " " HoldDecade
                       
           IF  RandomMovie(MovieRand)(59 - Charcount : 1)
                               EQUAL TO HoldDecade
           DISPLAY "IN IF"
           ADD 1 TO IDX
               DISPLAY "IDX : " IDX
           DISPLAY "Movie: "  RandomMovie(MovieRand)                       
           MOVE RandomMovie(MovieRand) TO SmovieName(idx)
           MOVE Comment(MovieRand) TO  SComment(idx)
      *        ELSE DISPLAY "Movie: "  RandomMovie(MovieRand)  
           END-IF                                       
           END-PERFORM.
